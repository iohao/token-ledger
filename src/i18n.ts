...
const MESSAGES = {
  "zh-CN": {
    ...
    navOverview: "概览",
    navDailyDetail: "每日用量统计",
    navMonthlyHistory: "月用量统计",
    navSyncInfo: "同步说明",
    ...
    dailyUsageTitle: "每日用量统计",
    readyToQueryDailyUsage: "准备查询每日用量统计",
    ...
    startDate: "开始日期",
    endDate: "结束日期",
    queryDailyUsage: "查询每日用量统计",
    querying: "查询中…",
    dailyUsageLoading: "正在查询每日用量统计…",
