...
const MESSAGES = {
  "zh-CN": {
    ...
    themeLight: "浅色模式",
    themeSystem: "跟随系统",
    themeSelectAria: "选择外观主题",
    appTagline: "本地 Token 用量工作台",
    navMain: "工作台",
    navUsage: "用量分析",
    navSettings: "设置",
    overviewTitle: "用量概览",
    overviewDescription: "查看当前消耗、成本和同步状态。",
    statusLabel: "同步状态",
    timeZone: "时区",
    pendingSessions: "待处理会话",
    dailyUsageDescription: "按日期范围查询每日模型用量。",
    monthlyHistoryDescription: "比较各月 Token 消耗和成本变化。",
    monthlyDetailDescription: "选择月份查看逐日、逐模型明细。",
    settingsEyebrow: "应用偏好",
    settingsTitle: "设置",
    settingsDescription: "管理显示偏好、数据来源、计价与应用更新。",
    pageSourceIdentifier: "页面标识",
    copyPageSource: "复制页面标识",
    pageSourceCopied: "页面标识已复制",
    settingsSectionNavAria: "设置分区",
    settingsGeneral: "通用",
    settingsGeneralDescription: "配置界面语言、外观主题与开发者选项。",
    settingsAppearance: "外观",
    settingsAppearanceDescription: "选择主题，或让应用跟随操作系统。",
    settingsData: "数据存储",
    settingsDataDescription: "管理本地 SQLite 数据库路径与 Codex 数据源。",
    settingsPricing: "模型计价",
    settingsPricingDescription: "配置各模型官方基准费率与中转自定义价格。",
    settingsUpdates: "软件更新",
    settingsUpdatesDescription: "检查版本并查看可用更新。",
    settingsAbout: "关于",
    settingsAboutDescription: "TokenLedger 的应用信息、源码仓库与隐私说明。",
    settingsDeveloper: "开发者选项",
    settingsDeveloperDescription: "控制用于开发协作的页面辅助信息。",
    showPageSourceIds: "显示页面唯一编号",
    showPageSourceIdsDescription: "在每个页面顶部显示可复制的源码标识。",
    settingsLanguageTitle: "界面语言",
    settingsLanguageDescription: "更改后立即应用，并在下次启动时保留。",
    themeModeTitle: "主题模式",
    themeModeDescription: "系统模式会随操作系统的外观设置切换。",
    diagnosticsTitle: "当前数据状态",
    officialBenchmarkRate: "官方基准",
    appPrivacyTitle: "本地数据隐私",
    appPrivacyDesc: "所有 Token 统计与会话分析均在本地完成，数据不离机。",
    pricingNotesTitle: "计费参考说明",
    applicationId: "应用标识",
    appPurposeLabel: "用途",
    appPurpose: "在本地汇总和分析 Codex 会话的 Token 用量与成本。",
    notSyncedYet: "尚未同步",
    syncingShort: "同步中…",
    countdown: "倒计时 {value}",
    periodToday: "今日统计",
    ...
    navMonthlyHistory: "用量汇总",
    navMonthlyDetail: "每月用量明细",
    navSyncInfo: "关于",
    ...
    activityWallEyebrow: "年度活跃度",
    activityWallTitle: "过去一年活跃墙",
    activityWallDescription: "按天统计 token 使用量，颜色越深表示当天越活跃。",
    activityWallSummary: "近一年活跃 {count} 天 · 累计 {total}",
    activityWallLegendLess: "少",
    activityWallLegendMore: "多",
    activityWallNoActivity: "无活动",
    activityWallAria: "过去一年活跃 {count} 天，总计 {total}",
    activityWallTooltipUsage: "{date} 消耗 {total} tokens（{compact}）",
    weekdayMonShort: "周一",
    weekdayWedShort: "周三",
    weekdayFriShort: "周五",
    localData: "本地数据",
    ...
    modelPricingHint: "默认使用官方价格。仅启用中转价格的模型会按下方自定义费率重新计算历史与后续费用。",
    pricingInput: "输入",
    pricingOutput: "补全",
    pricingCacheRead: "缓存读取",
    pricingCacheCreation: "缓存创建",
    perMillionTokens: "/ 1M tokens",
    relayPricingActive: "当前使用中转价格",
    officialPricingActive: "当前使用官方价格",
    useRelayPricing: "使用中转价格",
    officialPricingReference: "官方价格参考",
    savePricing: "保存价格",
    savingPricing: "保存中…",
    restoreRelayPreset: "恢复中转预设",
    cacheCreationAvailabilityNote: "只有会话日志提供 cache_creation_input_tokens 时才计算缓存创建费；没有该字段的记录按 0 处理。",
    pricingRequiredError: "请输入价格。",
    pricingInvalidError: "价格必须是大于或等于 0 的有效数字。",
    pricingValidationError: "请修正标记的价格后再保存。",
    pricingSaved: "模型价格已保存，历史统计已按新价格更新。",
    currentVersion: "当前版本",
    availableVersion: "可更新到",
    updatePublishedAtLabel: "发布时间",
    updatePublishedAt: "发布时间 {value}",
    checkForUpdates: "检查更新",
    checkingForUpdates: "检查中…",
    updateIsCurrent: "当前已经是最新版本。",
    updateAvailableStatus: "发现新版本 {version}。",
    updateAvailableBanner: "发现新版本 {version}",
    ...
    monthlyDetailTitle: "每月用量明细",
    readyToQueryMonthlyDetail: "准备查询每月用量明细",
    readyToQueryMonthlyDetailDescription: "先选择年份，再点击月份按钮查询。",
    ...
    monthlyDetailLoading: "正在查询每月用量明细…",
    monthlyDetailHint: "选择年份后，点击下方 12 个月按钮中的任意一个，即可查看该月每天的模型用量明细。",
    ...
    monthlyDetailSelectedTitle: "{month} 每日明细",
  ...
  "en-US": {
    ...
    appTagline: "Local token usage console",
    navMain: "Workspace",
    navUsage: "Usage analytics",
    navSettings: "Settings",
    overviewTitle: "Usage overview",
    overviewDescription: "Review current consumption, cost, and sync status.",
    statusLabel: "Sync status",
    timeZone: "Timezone",
    pendingSessions: "Pending sessions",
    dailyUsageDescription: "Query daily model usage for a date range.",
    monthlyHistoryDescription: "Compare monthly token consumption and cost.",
    monthlyDetailDescription: "Select a month for daily, per-model detail.",
    settingsEyebrow: "Application preferences",
    settingsTitle: "Settings",
    settingsDescription: "Manage display preferences, data sources, pricing, and updates.",
    pageSourceIdentifier: "Page ID",
    copyPageSource: "Copy page ID",
    pageSourceCopied: "Page ID copied",
    settingsSectionNavAria: "Settings sections",
    settingsGeneral: "General",
    settingsGeneralDescription: "Configure interface language, theme, and developer options.",
    settingsAppearance: "Appearance",
    settingsAppearanceDescription: "Choose a theme or follow the operating system.",
    settingsData: "Data & Storage",
    settingsDataDescription: "Manage local SQLite database path and Codex data source.",
    settingsPricing: "Model Pricing",
    settingsPricingDescription: "Configure official benchmark rates and relay pricing overrides.",
    settingsUpdates: "Software Updates",
    settingsUpdatesDescription: "Check the installed version and available updates.",
    settingsAbout: "About",
    settingsAboutDescription: "Application information, repository, and privacy notes.",
    settingsDeveloper: "Developer Options",
    settingsDeveloperDescription: "Control page information used for development collaboration.",
    showPageSourceIds: "Show page IDs",
    showPageSourceIdsDescription: "Show the copyable source identifier at the top of every page.",
    settingsLanguageTitle: "Interface language",
    settingsLanguageDescription: "Changes apply immediately and persist for the next launch.",
    themeModeTitle: "Theme mode",
    themeModeDescription: "System mode follows the operating system appearance setting.",
    diagnosticsTitle: "Current data status",
    officialBenchmarkRate: "Official benchmark",
    appPrivacyTitle: "Local Data Privacy",
    appPrivacyDesc: "All session logs and token calculations are processed and saved locally on your device.",
    pricingNotesTitle: "Pricing Reference Notes",
    applicationId: "Application ID",
    appPurposeLabel: "Purpose",
    appPurpose: "Locally aggregate and analyze token usage and cost from Codex sessions.",
    ...
    cacheCreationInput: "Cache creation",
    reasoning: "Reasoning",
    cost: "Cost",
    ...
    navMonthlyDetail: "Monthly detail",
    navSyncInfo: "About",
    dashboardTitle: "TokenLedger",
    ...
    activityWallEyebrow: "Year in review",
    activityWallTitle: "Activity wall for the last year",
    activityWallDescription: "Daily token usage shown as a heatmap. Darker cells indicate heavier activity.",
    activityWallSummary: "{count} active days in the last year · {total} total",
    activityWallLegendLess: "Less",
    activityWallLegendMore: "More",
    activityWallNoActivity: "No activity",
    activityWallAria: "{count} active days in the last year, {total} in total",
    activityWallTooltipUsage: "{total} tokens ({compact}) on {date}",
    weekdayMonShort: "Mon",
    weekdayWedShort: "Wed",
    weekdayFriShort: "Fri",
    ...
    appUpdateTitle: "Automatic updates",
    ...
    pricingSection: "Billing settings",
    modelPricingTitle: "Model pricing",
    modelPricingHint: "Official pricing remains the default. Historical and future costs use relay rates only for models enabled below.",
    pricingInput: "Input",
    pricingOutput: "Completion",
    pricingCacheRead: "Cache read",
    pricingCacheCreation: "Cache creation",
    perMillionTokens: "/ 1M tokens",
    relayPricingActive: "Using relay pricing",
    officialPricingActive: "Using official pricing",
    useRelayPricing: "Use relay pricing",
    officialPricingReference: "Official price reference",
    savePricing: "Save pricing",
    savingPricing: "Saving…",
    restoreRelayPreset: "Restore relay preset",
    cacheCreationAvailabilityNote: "Cache creation is charged only when session logs provide cache_creation_input_tokens. Records without the field use zero.",
    pricingRequiredError: "Enter a price.",
    pricingInvalidError: "Price must be a valid number greater than or equal to zero.",
    pricingValidationError: "Fix the highlighted prices before saving.",
    pricingSaved: "Model pricing saved. Historical totals now use the new rates.",
    currentVersion: "Current version",
    availableVersion: "Available version",
    updatePublishedAtLabel: "Published",
    updatePublishedAt: "Published {value}",
    checkForUpdates: "Check for updates",
    checkingForUpdates: "Checking…",
    updateIsCurrent: "You already have the latest version.",
    updateAvailableStatus: "Update {version} is ready to install.",
    updateAvailableBanner: "Update {version} is available",
    ...
    readyToQueryMonthlyDetail: "Ready to query monthly detail",
    readyToQueryMonthlyDetailDescription: "Choose a year, then click a month button to begin.",
    ...
    monthlyDetailLoading: "Loading monthly detail…",
    monthlyDetailHint:
      "Choose a year and click any of the 12 month buttons to load daily model usage for that month.",
    ...
    monthlyDetailSelectedTitle: "Daily detail for {month}",
    fallbackSuffix: " (fallback)",
...
const ZH_PRICING_NOTE_MAP: Record<string, string> = {
  "Official model prices are used unless a relay price override is enabled for that model.":
    "默认使用模型官方价格；只有显式启用中转价格的模型才使用覆盖费率。",
  "Cache creation charges apply only when session logs provide cache_creation_input_tokens; records without that field use zero cache creation tokens.":
    "只有会话日志提供 cache_creation_input_tokens 时才计算缓存创建费；没有该字段的记录按 0 个缓存创建 token 处理。",
