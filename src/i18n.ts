...
const MESSAGES = {
  "zh-CN": {
    ...
    settingsGeneral: "通用",
    settingsGeneralDescription: "选择界面显示语言。",
    settingsAppearance: "外观",
    settingsAppearanceDescription: "选择主题，或让应用跟随操作系统。",
    settingsData: "数据与诊断",
    settingsDataDescription: "管理本地数据库并检查当前数据状态。",
    settingsPricing: "模型计价",
    settingsPricingDescription: "配置成本估算所使用的模型单价。",
    settingsUpdates: "软件更新",
    settingsUpdatesDescription: "检查版本并查看可用更新。",
    settingsAbout: "关于",
    settingsAboutDescription: "TokenLedger 的应用信息与源码。",
  ...
  "en-US": {
    ...
    settingsGeneralDescription: "Choose the interface language.",
    settingsAppearance: "Appearance",
    settingsAppearanceDescription: "Choose a theme or follow the operating system.",
    settingsData: "Data & diagnostics",
    settingsDataDescription: "Manage the local database and inspect current data status.",
    settingsPricing: "Model pricing",
    settingsPricingDescription: "Configure model rates used for cost estimates.",
    settingsUpdates: "Software updates",
    settingsUpdatesDescription: "Check the installed version and available updates.",
    settingsAbout: "About",
    settingsAboutDescription: "Application and source information for TokenLedger.",
